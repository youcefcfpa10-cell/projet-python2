...
def open_PV2_5_form():
    ...
    tk.Label(
        root,
        text="المشاركة في إقامة العلاقات مع الجمعيات والمنظمات ذات الطابع الثقافي والرياضي",
        bg=form_bg,
        fg="#2F2F2F",
        font=("Arial", 20, "bold")
    ).pack(pady=5)
    ...
    elements = [
        "االتعبير و الإتصال",
        "   التفتح الذهني",
        "المشاركة في إقامة العلاقات ما بين المؤسسات",
        "المشاركة في إقامة العلاقات مع الجمعيات و المنظمات "
    ]
    ...
    def save_data():
        data = {
            ...
            "marks2": [v.get() for v in text_vars],
            "base_total": base_total_var.get(),
            "total2": total_var.get()
        }
        save_to_json_shared("PV2_5", data, "data1.json")
